...
# ==============================================================================
#### topic labeling ##########
#### Ceci est un exemple rien a voir avec ce qu'on a sur le dataset ####
...
# mise en page du streamlit
######_______________________________________________________#######

st.set_page_config(layout="wide")

choise = st.sidebar.selectbox('Fais ton choix',['Texte','CSV','Video'])
#csv et video en opition
if choise == 'Texte' :

    st.subheader('Topic Modeling and labelling app on text')

    text_input = st.text_area('copie ton texte ici', height=400)
